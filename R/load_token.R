...
#' @description load_token loads the access token using credentials provided by \code{\link{get_auth}}. Execution of function is possible only once per authentication process.
#' Usually you need not to run load_token() explicitly since the whole authentication process is managed by \code{\link{do_auth}}.
...
load_token = function(credlist) {
  # This function loads the access token using credentials from get_auth(). Execution of function is only possible once.
  #
  # Args:
